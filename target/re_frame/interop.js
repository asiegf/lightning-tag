...
return [(function (){var pred__1026 = cljs.core.instance_QMARK_;
var expr__1027 = reactive_val;
if(cljs.core.truth_(pred__1026.call(null,reagent.ratom.RAtom,expr__1027))){
return "ra";
} else {
if(cljs.core.truth_(pred__1026.call(null,reagent.ratom.RCursor,expr__1027))){
return "rc";
} else {
if(cljs.core.truth_(pred__1026.call(null,reagent.ratom.Reaction,expr__1027))){
return "rx";
} else {
if(cljs.core.truth_(pred__1026.call(null,reagent.ratom.Track,expr__1027))){
return "tr";
} else {
return "other";
}
