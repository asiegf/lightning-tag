...
var G__1249 = o;
goog.object.set(G__1249,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__1250__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__1250 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1251__i = 0, G__1251__a = new Array(arguments.length -  0);
while (G__1251__i < G__1251__a.length) {G__1251__a[G__1251__i] = arguments[G__1251__i + 0]; ++G__1251__i;}
  args = new cljs.core.IndexedSeq(G__1251__a,0,null);
} 
return G__1250__delegate.call(this,args);};
G__1250.cljs$lang$maxFixedArity = 0;
G__1250.cljs$lang$applyTo = (function (arglist__1252){
var args = cljs.core.seq(arglist__1252);
return G__1250__delegate(args);
});
G__1250.cljs$core$IFn$_invoke$arity$variadic = G__1250__delegate;
return G__1250;
})()
;
} else {
...
var G__1253 = o;
goog.object.set(G__1253,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__1257 = props;
var G__1257__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1257,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1257);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1257__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__1258 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1258,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__1258;
}
})(),id_class);
...
var G__1259 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1259) {
case (0):
...
var vec__1261 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1261,(0),null);
var id = cljs.core.nth.call(null,vec__1261,(1),null);
var className = cljs.core.nth.call(null,vec__1261,(2),null);
...
var temp__5808__auto___1264 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___1264 == null)){
} else {
var key_1265 = temp__5808__auto___1264;
(jsprops.key = key_1265);
}
...
var temp__5808__auto___1266 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___1266 == null)){
} else {
var key_1267 = temp__5808__auto___1266;
(jsprops.key = key_1267);
}
...
var temp__5808__auto___1268 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___1268 == null)){
} else {
var key_1269 = temp__5808__auto___1268;
(jsprops.key = key_1269);
}
...
var temp__5808__auto___1270 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___1270 == null)){
} else {
var key_1271 = temp__5808__auto___1270;
(jsprops.key = key_1271);
}
...
var temp__5808__auto___1272 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___1272 == null)){
} else {
var key_1273 = temp__5808__auto___1272;
(jsprops.key = key_1273);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__1274_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__1274_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__1275 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__1275,(0),null);
var derefed = cljs.core.nth.call(null,vec__1275,(1),null);
...
break;
default:
var G__1280 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__1281 = compiler;
v = G__1280;
compiler = G__1281;
continue;
...
var G__1282 = tag;
var G__1282__$1 = (((G__1282 instanceof cljs.core.Keyword))?G__1282.fqn:null);
switch (G__1282__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template1285 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template1285 = (function (opts,id,fn_to_element,parse_fn,meta1286){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta1286 = meta1286;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template1285.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_1287,meta1286__$1){
var self__ = this;
var _1287__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template1285(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta1286__$1));
}));

(reagent.impl.template.t_reagent$impl$template1285.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_1287){
var self__ = this;
var _1287__$1 = this;
return self__.meta1286;
}));

(reagent.impl.template.t_reagent$impl$template1285.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template1285.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template1285.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template1285.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template1285.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template1285.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta1286","meta1286",-1089215627,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template1285.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template1285.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template1285");

(reagent.impl.template.t_reagent$impl$template1285.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write.call(null,writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template1285");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template1285.
 */
reagent.impl.template.__GT_t_reagent$impl$template1285 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template1285(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta1286){
return (new reagent.impl.template.t_reagent$impl$template1285(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta1286));
});

}

return (new reagent.impl.template.t_reagent$impl$template1285(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
